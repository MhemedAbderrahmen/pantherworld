...
<template>
  <button
    type="button"
    class="notificationToggleButton flex gap-2 justify-between rounded-lg px-4 py-2 bottom-2 left-2 fixed focus:outline-none focus:ring focus:ring-emerald-300 active:ring active:ring-emerald-300 z-10 bg-base shadow"
    ...
    <div class="flex flex-row justify-between w-full relative">
      ...
      <div v-if="loggedIn" class="flex flex-row gap-1 items-center">
        ...
        <button
          type="button"
          @click="logout"
          class="font-display font-medium focus:outline-none focus:ring focus:ring-emerald-300 text-lg p-2 rounded-lg transition">
          log out
        </button>
      </div>
      <NuxtLink
        ...
        external
        v-if="!loggedIn"
        class="font-display font-medium bg-violet-700 hover:bg-violet-500 focus:bg-violet-500 active:bg-violet-500 focus:outline-none focus:ring focus:ring-violet-700 text-lg p-2 rounded-lg transition self-center flex flex-row gap-1 justify-between items-center"
