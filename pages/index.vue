...
<template>
  ...
  <section v-auto-animate>
    ...
    >
      <div class="flex flex-col justify-between">
        <p
          class="font-bold uppercase text-lg mb-4 bg-yellow-500 text-zinc-900 text-center rounded-lg"
        >
          Latest Spawn
        </p>
        <InventoryItem
  ...
  <section class="mb-16" v-auto-animate>
    <div v-if="data !== null">
      <p
        class="font-bold uppercase text-xl bg-yellow-500 text-zinc-900 text-center rounded-lg"
      >
        Current Population
      </p>
